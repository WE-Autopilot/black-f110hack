...
def convert_track_with_waypoints(track, track_int, track_ext, iter, obstacles):
    ...
    if args.base_path:
        map_path = os.path.join(args.base_path, f'maps/map{iter}.png')
        wpt_path = os.path.join(args.base_path, f'maps/map{iter}.csv')
    else:
        map_path = f'maps/map{iter}.png'
    ...
    yaml_data = {
        ...
        'map_path': map_path,
        'map_ext': '.png',
        'sx': args.origin_x,  # Use origin_x for sx
        'sy': args.origin_y,  # Use origin_y for sy
        'stheta': 0.0,
        'wpt_path': wpt_path,
        'wpt_delim': ',',
        'wpt_rowskip': 1,
